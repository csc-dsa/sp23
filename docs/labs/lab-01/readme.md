...
[Lab 1 Resources](https://github.com/csc-dsa/sp23/tree/main/lab_01_resources)
...
Notes: 
   ...
   - When attempting to read a file, the file **must be in the same directory as the executable!**
